...
def findEdge(pic):
    ...
    thresh1 = 1000
    thresh2 = 25
    avoidX = [0, 1, 2, 3, 4, 5, (pic.width - 1), (pic.width - 2),
              (pic.width - 3), (pic.width - 4), (pic.width - 5)]
    avoidY = [0, 1, 2, 3, 4, 5, (pic.height - 1), (pic.height - 2),
              (pic.height - 3), (pic.height - 4), (pic.height - 5)]
