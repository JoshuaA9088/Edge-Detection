...
def blur(pic):
    for x in range(0, pic.width, 1):
        for y in range(0, pic.height, 1):
            ...
            avgValR = (aVal[0] + bVal[0] + cVal[0] + eVal[0] + fVal[0] + gVal[0] + hVal[0] + iVal[0]) / 2
            avgValG = (aVal[1] + bVal[1] + cVal[1] + eVal[1] + fVal[1] + gVal[1] + hVal[1] + iVal[1]) / 2
            avgValB = (aVal[2] + bVal[2] + cVal[2] + eVal[2] + fVal[2] + gVal[2] + hVal[2] + iVal[2]) / 2
            if e[0] == -1 or e[0] == 1:
                pass
            else:
